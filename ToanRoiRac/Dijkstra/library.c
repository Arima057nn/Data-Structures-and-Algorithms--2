...
{
  JRB visited = make_jrb(); // danh dau cac dinh da duoc tham
  JRB cost = make_jrb(); // luu gia tri cua quang duong di ngan nhat hien tai
  JRB parent = make_jrb(); //luu lai dinh ke ngay truoc no
  JRB node;
  Dllist q = new_dllist(); hang doi
  Dllist path;
  Dllist n;
  Dllist adjs;
  int i, u, k;
